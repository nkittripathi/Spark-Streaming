...
public class ExecuteSparkStreamingJob extends AbstractNiFiProcessor {
    ...
    public ExecuteSparkStreamingJob() {
   ...
   // private static YarnClient client = null;
    ...
    private static final Log LOG = LogFactory.getLog(ExecuteSparkStreamingJob.class);
    String extraJars; 
